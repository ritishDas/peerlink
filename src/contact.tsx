...
export default function Contacts() {
  ...
  return (
    <Routes>
      ...
      <Route path="/register" element={<div className='h-screen flex justify-center items-center'><RegisterForm className='w-100' /></div>} />
      <Route path="/popup.html" element={
        login.status ? <div className="flex h-[78vh] overflow-scroll">
          <Calldialog />
